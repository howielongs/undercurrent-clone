...
sealed interface AssertCountInterface {
    fun assertCountUnexpired(expected: Int)
    fun assertCount(expected: Int)
}

sealed class BaseAssertCount : BaseCountTestClass(), AssertCountInterface
...
open class AssertCount<E : RootEntity0>(private val compObj: RootEntityCompanion0<E>) : BaseAssertCount() {
    ...
    override fun assertCountUnexpired(expected: Int) {
