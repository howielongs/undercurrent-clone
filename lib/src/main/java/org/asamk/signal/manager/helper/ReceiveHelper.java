    ...
    public void receiveMessagesContinuously(Manager.ReceiveMessageHandler handler) {
        while (!shouldStop) {
            try {
                ...
                logger.warn("Receiving messaging failed, retrying", e);
            }
        }
    }
        ...
        while (!shouldStop && remainingMessages != 0) {
            ...
            try {
                ...
                if (queueNotEmpty) {
                    ...
                    // Continue to wait another timeout for new messaging
                    continue;
                }
                ...
                logger.error("Unknown error when receiving messaging", e);
                continue;
            }
            ...
            try {
                ...
                logger.error("Unknown error when handling messaging", e);
            }
        }
    }
