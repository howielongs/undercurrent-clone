...
public interface Manager extends Closeable {
    ...
    /**
     * Add a handler to receive new messaging.
     * Will start receiving messaging from server, if not already started.
     */
    ...
    /**
     * Remove a handler to receive new messaging.
     * Will stop receiving messaging from server, if this was the last registered receiver.
     */
    ...
    /**
     * Receive new messaging from server, returns if no new message arrive in a timespan of timeout.
     */
