...
public class UpdateGroupCommand implements JsonRpcLocalCommand {
    ...
    public void attachToSubparser(final Subparser subparser) {
        ...
        subparser.addArgument("--set-permission-edit-details")
                ...
                .choices("every-member", "only-admins");
        subparser.addArgument("--set-permission-send-messaging")
                .help("Set permission to send messaging")
                .choices("every-member", "only-admins");

        subparser.addArgument("-e", "--expiration").type(int.class).help("Set expiration time of messaging (seconds)");
    }
    ...
    public void handleCommand(
        ...
        var groupSendMessagesPermission = getGroupPermission(ns.getString("set-permission-send-messaging"));
